...
<head>
    ...
    <!--<link rel="shortcut icon" type="image/png" href="{{asset(App\Models\Basicinfo::first()->favicon)}}"/>-->
     <link rel="icon" type="image/x-icon" href="{{asset('public/fav.jpg')}}">
    <link rel="shortcut icon" type="image/png" href="{{asset('public/fav.jpg')}}"/>
...
<body class="main-body">
                    ...
                    <ul class="inline-links d-flex justify-content-between">
                        ...
                        @else
                            <li class="text-center">
                                <a class="nav-cart-box" href="{{ url('/') }}">
                                    <img src="{{ asset('public/ihome.png') }}" alt="" width="30px"><br><span style="color: black;">Home</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="text-center">
                            <a href="javascript:void(0);" onclick="openNav()" class="nav-cart-box">
                                <img src="{{ asset('public/menu.png') }}" alt="" style="width: 30px;"><br><span style="color: black;">Category</span>
                            </a>
                        </li>
                        ...
                        <li class="text-center" style="height: 36px;position: relative;top: -40px;    left: 9px;">
                            ...
                            <li class="text-center">
                                <a class="nav-cart-box" href="{{ url('track-order') }}">
                                    <img src="{{ asset('public/truck.png') }}" alt="" style="width: 30px;"><br><span style="color: black;">Track Order</span>
                                </a>
                            </li>
                        ...
                        <li class="text-center">
                            ...
                            <a class="nav-cart-box" href="{{ url()->previous() }}">
                                <img src="{{ asset('public/arrows.png') }}" alt="" style="width: 30px;"><br><span style="color: black;">Back</span>
                            </a>
    ...
    <div id="message">
        ...
        <a href="tel:+88{{ $basicinfo->wp_1 }}" target="_blank" style="position: fixed;bottom: 230px;right: 6px;z-index:1111">
            <img src="{{asset('public/telephone.png')}}" style="height:60px;border-radius:50%">
        </a>

        <a href="https://wa.me/+88{{ $basicinfo->wp_1 }}?text=I%20am%20interested" style="position: fixed;bottom: 160px;right: 6px;z-index:1111">
