    ...
    <div class="main-header" id="myHeader" style="background: #fff;border-bottom: 1px solid #e9e9e9;">
        <div class="container">
            <div class="row" style="margin: 0">
                ...
                <div class="p-0 col-3 col-sm-3 col-md-3 col-lg-2 animate-dropdown top-cart-row" style="margin-top: 15px;" id="headcart">
                    <div class="">
                    ...
                    <div class="d-none d-xl-inline-block" id="d-sm-none">
                        ...
                        @if (Auth::id())
                            <a href="#" type="button" onclick="openProfileNav()"
                                style="color: #000000;font-size:20px"><i class="fa-solid fa-user"></i></a>
                        @else
                            ...
                            <div class="items-cart-inner">
                                <div class="basket" style="padding: 0;display:flex;">
                                    <span style="color: #000000;font-weight:bold">৳
                                        ...
                                        style="    padding-top: 26px;font-size: 20px;color: #000000;"></i>
                                </div>
                            </div>
                        </a>
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="submit" class="input-group-text bg-primary text-light"
                                    style="background: #000339 !important;padding: 10.7px;margin-bottom: 2px;margin-left: -10px;margin-top: -1px;border-radius: 0px 4px 4px 0px;">
