...
<div class="p-0 mt-2 row">
    ...
    <div class="col-lg-3" id="d-sm-none">
        @php
            $ad = App\Models\Addbanner::where('id', 5)->select('id', 'add_link', 'add_image')->first();
            $ad2 = App\Models\Addbanner::where('id', 6)->select('id', 'add_link', 'add_image')->first();
        @endphp
...
<div class="container p-0 pb-2 ">
    @if (count($topproducts) > 0)
        <div class="pb-2 bg-white row" style="background:#efefef !important;">
            <div class="col-12"
                style="border-bottom: 1px solid #000339;padding-left: 0;display: flex;justify-content: space-between;">
                ...
                <a href="{{ url('promotional/products') }}" class="mb-0 btn btn-sm"
                    style="padding: 4px;height: 26px;color: white;font-weight: bold;margin-top:9px;font-size:12px; background:#000339;">VIEW
                    ALL</a>
            </div>
            <div class="col-12">
            ...
            <div class="pb-0 bg-white row" style="background:#efefef !important;">
                <div class="col-12"
                    ...
                    <a href="{{ url('products/category/' . $categoryproduct->slug) }}"
                        ...
                        style="padding: 4px;height: 26px;color: white;font-weight: bold;margin-top:9px;font-size:12px;background: #000339;border: 1px solid #000339;">VIEW
                        ALL</a>
                </div>
                ...
                @forelse ($categoryproduct->mainproducts as $product)
                    @php
                        $firstcatepro = App\Models\Product::with([
                            ...
                            ->where('id', json_decode($product->RelatedProductIds)[0]->productID)
                            ->select('id', 'ProductName')
                            ->first();
